    ...
    <div class="tabla overflow-auto br10 h100p w100p">
        <?php if ($_SESSION["usuario"]->des_rol !== "Reportes") : ?>
            <form action="../Request/Control.php" method="post">
                <table class="collapse w100p color7" id="tabla">
                    <thead class="mayus white color7 br20 overflow-hidden sticky top0">
                        ...
                        <th class="p10 fz14 relative f-row jc-c">
                            ...
                            <?php if ($_SESSION["usuario"]->des_rol === "Administrador") : ?>
                                <a class="color1 absolute p5 br5 top0 white derecha50 top5 leyenda_top" href="Empleados.php?back=control">
        ...
        <table class="collapse color7 w100p">
            <thead class="mayus white color1 br20 overflow-hidden sticky top0">
                ...
                <th class="p10 fz14" style="border-right: 2px solid;">Observaciones</th>
                <th class="p10 fz14">Salida</th>
                <th class="p10 fz14">Observaciones</th>
            </thead>
            <tbody id="tbody">
                <?php foreach (Controles::Mostrar() as $item) : ?>
                    <tr class="white fz12 arial hover6 pointer" id="<?= $item->id_control ?>" ondblclick="BuscarControl_Json(this)">
